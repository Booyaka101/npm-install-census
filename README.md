...
<!-- auto:headline -->
> **28 of 3,192** packages in the current sample run an install script. **17** score HIGH. The most-installed one is `esbuild` at 255.5M downloads a week.
>
> <sub>Rebuilt 2026-09-14.</sub>
<!-- /auto:headline -->
