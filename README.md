...
<!-- auto:headline -->
> **25 of 3,077** packages in the current sample run an install script. **18** score HIGH. The most-installed one is `esbuild` at 255.5M downloads a week.
>
> <sub>Rebuilt 2026-08-15.</sub>
<!-- /auto:headline -->
