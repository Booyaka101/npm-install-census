...
<!-- auto:headline -->
> **24 of 3,093** packages in the current sample run an install script. **16** score HIGH. The most-installed one is `esbuild` at 255.5M downloads a week.
>
> <sub>Rebuilt 2026-09-02.</sub>
<!-- /auto:headline -->
