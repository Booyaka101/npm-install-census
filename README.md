...
<!-- auto:headline -->
> **26 of 3,126** packages in the current sample run an install script. **17** score HIGH. The most-installed one is `esbuild` at 255.5M downloads a week.
>
> <sub>Rebuilt 2026-09-06.</sub>
<!-- /auto:headline -->
